...
<div class="popup-contents creatRoom-contents common-popup popup-down">
    <div class="popup-inner center">
        ...
        <input type="button" value="CREATE!" id="newRoomSubmit" class="btn btn-primary"
               onclick="gameCreate($('.center#roomName').val())">
    </div>
</div>
...
<div class="popup-contents rename-contents common-popup">
    <div class="popup-inner center">
        ...
        <input type="button" value="완료" id="reNameSubmit" class="btn btn-primary" onclick="nicknameChange()">
    </div>
</div>
...
<div class="popup-contents setting-contents common-popup popup-down">
    <div class="popup-inner center setting-btn-list">
        ...
        <input type="button" value="회원탈퇴" id="remveUser-btn" class="btn btn-thin" onclick="userUnregister()">
    </div>
</div>
...
<div class="popup-contents pw-change-contents common-popup">
    <div class="popup-inner center">
        ...
        <input type="button" value="완료" id="PwChangeSubmit" class="btn btn-primary" onclick="pwChange()">
    </div>
</div>
    ...
    <div class="inner">
        ...
        <div class="user-area area-box">
            <div class="user-wrap flex-box gap-40 item-center">
                <div class="user-icon">
                    <div class="user-icon-img" id="user">
                ...
                <div class="user-infor">
                    ...
                    <div class="user-score">${userWin}승 ${userLose}패 ${userDraw}무</div>
                </div>
            </div>
            ...
            <div class="game-list-wrap area-box">
                <div class="game-list-controls flex-box just-between">
                    <div class="flex-box gap-15 item-center">
                        <h2>GAME LIST</h2>
                        <button type="button" id="reloadBtn" onclick="makeRoomList(${nowPage})">
                ...
                <ul class="game-list">
                    <li>
                        <div class="flex-box just-between" id="room1">
...
<%--                                        <span class="room-states state-wait">대기중</span>--%>
                                        <span class="room-states">대기중</span>
                                    </div>
                            ...
                            <div class="room-stage" id="room-stage1">
...
<%--                                        <span class="room-states state-end">게임종료</span>--%>
            ...
            <div class="ranking-wrap area-box area-box">
                ...
                <ol class="ranking-list">
                    <li class="first-rank">
                        <div class="user-icon">
                            <div class="user-icon-img" id="rank1">
                                <img src="/assets/images/profile_icon.png" alt="프로필 사진">
                            </div>
                            <div class="first-num rank-num">1</div>
                        </div>
                        <div class="ranker-info" id="0">
...
<script src="/assets/js/roomList.js"></script>
<!-- main js -->
<script>
    $(document).ready(function () {
        ...
        makeRankerList();
        let userIcon = loadIcon("${userId}");
        $('.user-icon-img#user').html('<img class="user-icon-img" src="' + userIcon + '" />');
        $('#editIcon').on("change", function() {changeIcon("${userId}")});
    });
