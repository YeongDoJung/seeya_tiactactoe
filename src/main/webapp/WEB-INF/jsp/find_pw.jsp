...
<!-- 공통::가이드버튼 -->
    ...
    <section id="findPW" class="form-bg">
        ...
        <div class="inner form-wrap">
            ...
            <div class="form-box">
                <div class="input-box">
                    ...
                    <div class="input-wrap">
                        <input type="text" placeholder="아이디" id="addID" maxlength="10">
                    </div>
                </div>
                <div class="input-box">
                    <div class="input-label">
            ...
            <div class="form-box">
                <input type="submit" value="인증코드 전송" id="sandCode" class="btn btn-light" onclick="sendCodePW()">
            </div>
        </div>
    </section>
