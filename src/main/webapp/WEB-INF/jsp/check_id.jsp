...
<!-- 공통::가이드버튼 -->
    ...
    <section id="checkId" class="form-bg">
        ...
        <div class="inner form-wrap">
            ...
            <div class="form-box" id="inform">
                <p>USER-NAME님의 아이디는<br>
                <span class="import">"USER-ID"</span>입니다.
            
            </div>
            <div class="form-box">
                <input type="button" value="로그인 페이지로" id="goLogin" class="btn btn-primary" onclick="location.href='login'">
            </div>
        </div>
    </section>
    ...
    <script>
        $(document).ready(function() {
            ...
            console.log('ID:', id); // 디버깅용
            console.log('Nickname:', nickname); // 디버깅용

            // HTML 업데이트
            $(".form-box#inform").html(`<p>${param.nickname}님의 아이디는<br><span class="import">${param.id}</span>입니다.</p>`);
        });
