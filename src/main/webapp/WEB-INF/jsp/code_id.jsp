...
<!-- 공통::가이드버튼 -->
    ...
    <section id="codeID" class="form-bg">
        ...
        <div class="inner form-wrap">
            ...
            <div class="form-box">
                <input type="submit" value="확인" id="checkCode" class="btn btn-light" onclick="checkIdCodeBtn()">
            </div>
        </div>
    </section>
                ...
                $.ajax({
                    ...
                    success (data) {
                        ...
                        if (data.result === false) {
                            ...
                            location.href='check_id?id=' + data.userId + '&' + 'nickname=' + data.userNickname;
                        }
                    },
                    error (e) {
                        console.log(e)
